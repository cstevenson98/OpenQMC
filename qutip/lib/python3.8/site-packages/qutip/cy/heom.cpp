 ...
 *     cdef int ncolin = A.shape[1]
 */
  __pyx_tuple__28 = PyTuple_Pack(16, __pyx_n_s_A, __pyx_n_s_row_scale, __pyx_n_s_col_scale, __pyx_n_s_insertrow, __pyx_n_s_insertcol, __pyx_n_s_nrowin, __pyx_n_s_ncolin, __pyx_n_s_nnz, __pyx_n_s_nrowout, __pyx_n_s_ncolout, __pyx_n_s_kk, __pyx_n_s_temp, __pyx_n_s_temp2, __pyx_n_s_ind, __pyx_n_s_ptr_in, __pyx_n_s_ptr_out); if (unlikely(!__pyx_tuple__28)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__28);
  __Pyx_GIVEREF(__pyx_tuple__28);
  __pyx_codeobj__29 = (PyObject*)__Pyx_PyCode_New(5, 0, 16, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__28, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_qutip_cy_heom_pyx, __pyx_n_s_cy_pad_csr, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__29)) __PYX_ERR(0, 9, __pyx_L1_error)
